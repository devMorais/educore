"""
Fixtures compartilhadas dos testes do ai-service.
...
(Mesma infra criada no D-15 — recriada aqui porque esta branch partiu da
`main` antes do D-15 ser mergeado. Ao mergear os dois, este arquivo vai
colidir/duplicar; nesse caso, manter uma cópia só.)
"""
import pytest
