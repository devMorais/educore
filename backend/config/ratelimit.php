...
return [
    ...
    // ── D-02: Recuperação de senha (chave = IP) ──
    'forgot_password_per_hour'  => (int) env('RATE_FORGOT_PASSWORD_PER_HOUR', 5),   // solicitar link: 5/h por IP
    'reset_password_per_minute' => (int) env('RATE_RESET_PASSWORD_PER_MINUTE', 10), // redefinir: 10/min por IP
