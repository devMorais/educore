...
import { NotificationBell } from '../../feedback/notification-bell/notification-bell.molecule';

@Component({
  selector: 'app-navbar',
  imports: [RouterLink, RouterLinkActive, CommonModule, Logo, NotificationBell],
  templateUrl: './navbar.molecule.html',
  styleUrl: './navbar.molecule.scss',
})
export class Navbar {
