...
export class Upload implements OnInit, OnDestroy {
  ...
  // Controla a abertura da sidebar no mobile
  menuAberto = signal(false);

  // Ícone PrimeIcons de cada tipo de conteúdo
  ...
  // Carrega os últimos 10 documentos para a lista "Documentos Recentes"
  loadDocuments() {
  ...
  // Busca os tipos já gerados de um documento e guarda no mapa
