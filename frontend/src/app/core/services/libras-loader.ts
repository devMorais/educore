...
import type { LibrasVideo } from '../models/content.models';
...
export class LibrasLoaderService {
  ...
  private carregarVLibras(config: Record<string, any>): void {
  ...
  private htInstance: any = null;

  private carregarHandTalk(config: Record<string, any>): void {
